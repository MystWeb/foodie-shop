...
public class Orders implements Serializable {
    ...
    @Schema(title = "买家是否评价;1：已评价，0：未评价")
    ...
    @Schema(title = "逻辑删除状态;1: 删除 0:未删除")

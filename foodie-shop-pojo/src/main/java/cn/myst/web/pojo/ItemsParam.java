...
public class ItemsParam implements Serializable {
    ...
    @Schema(name = "生产厂址 生产厂址，例：大灰狼生产基地")
    ...
    @Schema(name = "存储方法 存储方法，例：常温5~25°")
